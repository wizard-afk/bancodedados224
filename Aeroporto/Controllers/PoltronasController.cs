...
namespace Aeroporto.Controllers
{
    public class PoltronasController : Controller
    {
        ...
        {
            var aeroportoContext = _context.Poltronas.Include(p => p.Aeronave);
        ...
        public async Task<IActionResult> Create([Bind("Id,AeronaveId,Numero,Localizacao,Disponivel")] Poltrona poltrona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AeronaveId,Numero,Localizacao,Disponivel")] Poltrona poltrona)
        {
            if (id != poltrona.Id)
            {
                return NotFound();
